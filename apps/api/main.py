...
is_testing = "pytest" in os.getenv("_", "") or os.getenv("TESTING", "false").lower() == "true"

if is_testing and test_env_path.exists():
...
# Load production .env if it exists and environment is production
